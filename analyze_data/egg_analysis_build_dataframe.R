...
egg_database_raw <- read.delim("egg_database.tsv",stringsAsFactors=F) 
...
#egg_database_raw$group <- plyr::mapvalues(egg_database_raw$tax_order,groups$order,groups$group,warn_missing=F)
