...
# This file describes how to use the following R scripts to reproduce the
#  figures in the Insect Egg Evolution manuscripts
# All files in this directory were written by SHC between 2017 and 2018

# Each file should be executed in R
# Dependency versions are listed at the end of this file
...
egg_analysis_ouwie_ecology.R
	# need to run 4x for aquatic, parasitoid, wingless, and migratory
	# need to rerun 2x parasitoid and aquatic after changing relaxed to strict 
	#     (some --> ancestral) in egg_analysis_eco_functions.R
	# need to rerun aquatic version after setting aquatic to combined aquatic + riparian
	#     in egg_analysis_aquatic.R
	# need to rerun parasitoid version after setting parasitoid to combined endo + ecto 
	#     in egg_analysis_parasitoid.R

egg_analysis_plot_ecology.R
egg_analysis_separate_ecoallometry.R
	# need to run 2x for aquatic and parasitoid
